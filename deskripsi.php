    ...
    if(isset($_FILES['tfoto']['name'])) {
      ...
      move_uploaded_file($_FILES['tfoto']['tmp_name'],$lokasifoto.$namafoto);
            ...
            //Data akan di edit
                ...
                $simpan = mysqli_query($koneksi, "INSERT INTO produk2 (`foto`,`nama_produk`,`harga_produk`,`kategori`,`deskripsi`)
                                          VALUES ('$namafoto',
                                                 '$_POST[tnama_produk]',
                                                 '$_POST[tharga_produk]',
                                                 '$_POST[tkategori]',
        ...
        if(isset($_GET['id']))
{
    ...
    if($_GET['id'] == "")
    {
        $tampil = mysqli_query($koneksi, "SELECT * FROM produk2 WHERE id = '$_GET[id]' ");
